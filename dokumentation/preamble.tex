...
\newlength{\imagewidth}
\setlength{\imagewidth}{0.6\columnwidth}
...
\ihead{Jan Hoegen, Maileen Schwenk}
...
\AtBeginDocument{
    \subtitle{Laborbericht zum Versuch Nr.~\printlabor}
    \hypersetup{
        pdftitle = {RT Labor \printlabor\ | Hoegen, Schwenk},
    }
}
