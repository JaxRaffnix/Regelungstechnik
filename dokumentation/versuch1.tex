...
\section{Temperaturregler}
    ...
    \begin{figure*}
        ...
        \includesvg[width=2\imagewidth, inkscapelatex=false]{../versuch1/temp_regler.svg}
        \caption{Zeitsignal der Regelgrößen}
        \label{fig:temp_regler}
        % \legend{blau: Führungsgröße, rot: Stellgröße, grün: Regelgröße}
    \end{figure*}
...
\section{Anhang}
    ...
    \lstinputlisting[language=MATLAB]{../versuch1/sinus.m}

    \lstinputlisting[language=MATLAB]{../versuch1/tiefpass.m}
